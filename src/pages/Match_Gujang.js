...
const Gujang = () => (
  <div style={{ border: "10px", height: "700px" }} className="Gujang">
    ...
    >
          ...
          <tr align="center">
            ...
            <td>
              <select
                ...
                style={{ width: "300px", fontSize: "13pt" }}
              >
                <option>서울</option>
                <option>인천,경기</option>
                <option>강원</option>
      ...
      <Scrollbars
        className="scroll"
        style={{ width: "1350px", height: "480px", border: "2px" }}
      >
        <div
          style={{ border: "2px", width: "1200px" }}
          className="GujangTableDiv"
        >
          <table
            className="MatchList"
            style={{
          ...
          >
            <tbody>
              <tr style={{ border: "2px solid #503396" }}>
                <td
                  width="300px"
                  style={{ border: "2px solid #503396", height: "150px" }}
                >
                  <img
                    src={Thum}
                    alt=""
                ...
                >
                  <b style={{ fontSize: "20pt", marginLeft: "10px" }}>
                    도봉 라온 풋살장 A
                  </b>
                  <br />
                  <b style={{ fontSize: "15pt", marginLeft: "10px" }}>
                    주소 : 서울시 도봉구 방학동 553-2
                  </b>
                  <br />
                  <hr />
                  <b style={{ fontSize: "15pt", marginLeft: "10px" }}>
