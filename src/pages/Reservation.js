...
const Reservation = () => (
  <div>
    <Scrollbars
      id="ReScroll"
      className="ReScroll"
      style={{ width: "100%", height: "683px", border: "2px" }}
    >
      <Carousel
        className="Carousel"
        width="100%"
      ...
      >
        <img
          src="https://plab-football.s3.amazonaws.com/media/dobong_coner.jpg"
          alt="First Slide"
          style={{ border: "2px" }}
        />
        <img
          src="https://plab-football.s3.amazonaws.com/media/doboal_goal.jpg"
          alt=""
        />
        <img
      ...
      >
        <br />
        <b className="txt1">도봉 루다 풋살장</b>
        <br />
        <b className="txt2">서울 도봉구 방학동 271-2 </b>
        <b className="txt3">// 지도보기</b>
        <br />
        <br />
          ...
          <tbody>
            <tr>
              <td
                align="center"
                width="200px"
                style={{ border: "1px solid rgba(0,0,0,.1)", height: "200px" }}
              >
        ...
        <div>
          ...
          >
            <tbody>
              ...
              <tr>
                <td align="center">
                  <b style={{ fontSize: "15pt" }}>총 인원 : 5</b>
                  <br />
              ...
              <tr>
                <td align="center">
                  ...
                  <br />
                  <b style={{ fontSize: "80pt" }}>3</b>
                  <br />
                  <br />
                  <NavLink
                    to="/Match/Gujang/Reservation/Payment"
          ...
          <tbody>
            <tr>
              <td
                ...
                style={{ border: "1px solid rgba(0,0,0,.1)", height: "200px" }}
              >
                <img src={Parking} alt="" style={{ width: "120px" }} />
                <br />
                <b>주차</b>
              </td>
              <td
              ...
              >
                <img
                  src={Shoes}
                  alt=""
                  style={{ width: "120px", height: "70px", marginTop: "30px" }}
                />
                <br />
                <br />
                <b>풋살화 대여</b>
